...
public class ToothpasteMinerHPNoise implements StochasticNetLogMiner{

	private static final Logger LOGGER = LogManager.getLogger();

	private static final String NOISE = "0.1";
	...
	public String getReadableID() {
		return "ToothpasteMinerNoise" + NOISE;
	}
			...
			throws Exception
	{
		...
		LOGGER.info("Invoking Toothpaste miner with noise reduction {}, out of process, on {} ", 
					NOISE, logFile );
