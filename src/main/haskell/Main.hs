...
toothpasteArgs = ToothpasteArgs{
    ...
    help "Discover stochastic models from event logs" 
        &= summary "Toothpaste Miner 0.8.3, 2021 (GPL)" 
...
ptreeOnInt :: ToothpasteArgs -> String -> PPTree String
ptreeOnInt tpargs rawlog   = pptreeIntToStr (Toothpaste.discoverGen intlog) m
